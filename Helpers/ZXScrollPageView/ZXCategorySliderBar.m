...
- (void)setSelectIndex:(NSInteger)index{
    ...
    [self adjustContentOffsetToIndex:index completeHanle:^{
        ...
        itemView.contentLabel.textColor = [UIColor whiteColor];
        itemView.contentLabel.font = [UIFont systemFontOfSize:13.0f weight:5.0f];
        NSNotification *notification = [[NSNotification alloc]initWithName:RESETCOLORNOTIFICATION object:@"color" userInfo:@{@"color":[UIColor whiteColor],@"index":@(self.currentIndex)}];
...
- (void)adjustIndicateViewX:(UIScrollView *)scrollView direction:(NSString *)direction{
    ...
    if ([direction isEqualToString:@"向右"]) {
        ...
        view.contentLabel.font = [UIFont systemFontOfSize:13.0f weight:0.0f];
...
- (UICollectionView *)mainCollectionView
{
    if (!_mainCollectionView) {
        ...
        _mainCollectionView.backgroundColor = QFC_Color_30AC65;//[UIColor whiteColor];
    }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSNotification *notification = [[NSNotification alloc]initWithName:RESETCOLORNOTIFICATION object:@"color" userInfo:@{@"color":[UIColor whiteColor],@"index":@(indexPath.row)}];
    [[NSNotificationCenter defaultCenter]postNotification:notification];
    ...
    cell.contentLabel.font = [UIFont systemFontOfSize:13 weight:0.0f];
