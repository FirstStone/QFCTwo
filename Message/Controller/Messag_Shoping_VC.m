...
#import "Messag_Shoping_VC.h"

@interface Messag_Shoping_VC ()<UIScrollViewDelegate>
...
@implementation Messag_Shoping_VC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < self.itemArray.count; i++) {
        Message_Shoping_Tableview *LiftTableview = [[Message_Shoping_Tableview alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * i, 0, SCREEN_WIDTH, is_IPhone_X ? (SCREEN_HEIGHT - 88.0f - 34 - 40.0f) : (SCREEN_HEIGHT - 64.0f - 40.0f)) style:UITableViewStyleGrouped];
