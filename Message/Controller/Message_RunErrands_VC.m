...
#import "Message_RunErrands_VC.h"

@interface Message_RunErrands_VC ()<UIScrollViewDelegate>
...
@implementation Message_RunErrands_VC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < self.itemArray.count; i++) {
        Message_RunErrands_Tableview *LiftTableview = [[Message_RunErrands_Tableview alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * i, 0, SCREEN_WIDTH, is_IPhone_X ? (SCREEN_HEIGHT - 88.0f - 34 - 40.0f) : (SCREEN_HEIGHT - 64.0f - 40.0f)) style:UITableViewStylePlain];
