//
//  H5_Mine_MyShopStoreViewController.m
//  QFC
//
...
#import "H5_Mine_MyShopStoreViewController.h"

@interface H5_Mine_MyShopStoreViewController ()<WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>
@property (strong, nonatomic) WKWebView *MyWKWebView;
@property (strong, nonatomic) IBOutlet UIView *BackView;
@end

@implementation H5_Mine_MyShopStoreViewController
...
- (void)viewDidLoad {
    ...
    // 2.创建请求
    NSMutableURLRequest *request =[NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://www.tiaoxinkeji.com/dist/#/IosSmallshop/?,%@,%@",[[NSUserDefaults standardUserDefaults] objectForKey:User_Mid], self.merchant_id]]];
    // 3.加载网页
