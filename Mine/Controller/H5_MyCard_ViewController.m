...
#import "H5_MyCard_ViewController.h"

@interface H5_MyCard_ViewController ()<WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>
@property (strong, nonatomic) WKWebView *MyWKWebView;
@property (strong, nonatomic) IBOutlet UIView *BackView;
@end

@implementation H5_MyCard_ViewController
...
- (void)viewDidLoad {
    ...
    // 2.创建请求
    NSMutableURLRequest *request =[NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://www.tiaoxinkeji.com/dist/#/IosCoupon/?,%@",[[NSUserDefaults standardUserDefaults] objectForKey:User_Mid]]]];
    // 3.加载网页
