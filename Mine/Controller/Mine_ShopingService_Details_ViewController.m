//
//  Mine_ShopingService_Details_ViewController.m
//  QFC
//
...
#import "Mine_ShopingService_Details_ViewController.h"
#define CellID_MineSetUPCell @"MineSetUPCell"
@interface Mine_ShopingService_Details_ViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation Mine_ShopingService_Details_ViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.Title_Array = @[@"店铺头像", @"店铺名称", @"联系方式", @"联系地址", @"经营范围"];
