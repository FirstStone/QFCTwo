...
@implementation Mine_SetUP_Phone_VC
...
- (IBAction)SureButtonClick:(id)sender {
    ...
    }else if (self.Phone_Field.text.length == 0){
        [MBProgressHUD py_showError:@"请输入新手机号" toView:nil];
        [MBProgressHUD setAnimationDelay:0.7f];
    }else {
...
- (void)LoadingDataSoure {
    /**
     手机号修改
     URL : https://www.txkuaiyou.com/index/centres/uPhones
     参数 :
     phone
     修改的手机号
     note
