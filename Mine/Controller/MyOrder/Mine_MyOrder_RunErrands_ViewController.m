...
//
//  Mine_MyOrder_RunErrands_ViewController.m
//  QFC
//
...
#import "Mine_MyOrder_RunErrands_ViewController.h"

@interface Mine_MyOrder_RunErrands_ViewController ()<UIScrollViewDelegate>
...
@implementation Mine_MyOrder_RunErrands_ViewController
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < self.itemArray.count; i++) {
        Mine_MyOrder_ButtonAndTableView_View *LiftTableview = [[Mine_MyOrder_ButtonAndTableView_View alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * i, 0, SCREEN_WIDTH, is_IPhone_X ? (SCREEN_HEIGHT - 88.0f - 34- 40.0f) : (SCREEN_HEIGHT - 64.0f - 40.0f))];
        LiftTableview.My_NAVC = self.navigationController;
        LiftTableview.MyOrderViewStyle = MyOrderViewStyleRunErrands;
