//
//  Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_VC.m
//  QFC
//
...
#import "Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_VC.h"

@interface Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_VC ()<UIScrollViewDelegate>
...
@implementation Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_VC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < self.itemArray.count; i++) {
        Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_TableView *LiftTableview = [[Mine_MyOrder_RunErrands_Shoping_HouseKeeping_AllService_TableView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH * i, 0, SCREEN_WIDTH, is_IPhone_X ? (SCREEN_HEIGHT - 88.0f - 34 - 40.0f) : (SCREEN_HEIGHT - 64.0f - 40.0f)) style:UITableViewStyleGrouped];
