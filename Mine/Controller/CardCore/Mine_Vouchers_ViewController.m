//
//  Mine_Vouchers_ViewController.m
//  QFC
//
...
#import "Mine_Vouchers_ViewController.h"
#define CellID_MineMyCardViewCell @"MineMyCardViewCell"
@interface Mine_Vouchers_ViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) IBOutlet Basic_TableView *tableView;

@property (nonatomic, strong) NSMutableArray *dataArray;
@end

@implementation Mine_Vouchers_ViewController
